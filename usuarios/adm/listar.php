...
<body>
    ...
    <form class='form-listar' style="text-align: center;">
        ...
        <p><a href='excluir.php?id_cliente=<?=$linha["id_cliente"]?>'>excluir</a></p>
        <p><a href='editar.php?id_cliente=<?=$linha["id_cliente"]?>'>Editar</a></p>
    </form>
        <?php }
...
if(isset($_GET['editarnok'])){
    echo "edição não sucedida";
}
if(isset($_GET['deleteok'])){
    echo "Delete bem sucedido";
}
if(isset($_GET['deletenok'])){
    echo "Delete não sucedido";
}?>
</form></div>