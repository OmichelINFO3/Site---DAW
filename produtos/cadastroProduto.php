...
<body>
    ...
    <div id="container">
    <form action="cadastroProduto_ok.php" method="POST" class='form' enctype="multipart/form-data">
        ...
        <div>
            ...
            <div style="display:flex;">
                <input class="inputs" type="radio" name="disp" value='Sim'/><p  style="border-radius:4px; text-align:center; color:white; background-color: green; margin:0; width:40px;">Sim</p>
            </div>
            <br>
            <div style="display:flex;">
                <input class="inputs" type="radio" name="disp" value='Não'/><p  style="border-radius:4px; text-align:center; color:white; background-color: green; margin:0; width:40px;">Não</p>
            </div>
        </div>
        <div>
